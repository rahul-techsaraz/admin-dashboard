 ...
 const dispatch = useDispatch();
  ...
  return (
    <div className='full-contain'>
                  ...
                  <button onClick={() => dispatch(updateEditMode({flag:!isEdit}))} className='edit-btn'>Edit</button>    
                      </div>

                      <div className='grid-parent'>
                      <div className='grid-parent-child'>  
                  <span className='exam-text'>Exam Description</span>
                  <div className='exam-list-p'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean at nunc sem. Donec eu consequat turpis. Aenean porta in ligula venenatis congue. Duis eget cursus lacus Morbi posuere</div> 
              </div>
              <div className='grid-parent-child'>  
                  <span className='exam-text'>Exam Description</span>
                  <div className='exam-list-p'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean at nunc sem. Donec eu consequat turpis. Aenean porta in ligula venenatis congue. Duis eget cursus lacus Morbi posuere</div> 
