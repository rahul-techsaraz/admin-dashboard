  ...
  return (
    <>
      <div style={{ display: " flex", flexWrap: "wrap", alignItems:'center', gap: '3rem', margin: 'auto', padding: 'auto' }}>
        ...
        />
        <div className="form-group"  style={facultyList.length > 0 ?  {border:'solid #e83e8c 1px',borderRadius:"1rem", display:"flex", justifyContent:"space-between", flexWrap:"wrap", maxWidth:"400px", padding:"7px"} : {border:'solid #e83e8c 1px',borderRadius:"1rem", display:"none"}}>
