                ...
                <ul className='header-dropdown'>
                  <li className='dropdown'>
                    ...
                    <ul className='dropdown-menu slideUp'>
                      <li>
                        <Link to={'/'}>2017 Year</Link>
                      </li>
                      <li>
                        <Link to={'/'}>2016 Year</Link>
                      </li>
                      <li>
                        <Link to={'/'}>2015 Year</Link>
                      </li>
                    </ul>
                  </li>
                  <li className='remove'>
                    <Link role='button' className='boxs-close'>
                  ...
                  <div className='col-lg-5 col-md-6'>
                    <div className='top-report mb-4'>
                      <h3 className='mt-0 mb-0'>
                        240 <i className='zmdi zmdi-trending-up float-right' />
                      </h3>
                    ...
                    <div className='top-report'>
                      <h3 className='mt-0 mb-0'>
                        50.5 Gb <i className='zmdi zmdi-trending-up float-right' />
                      </h3>
