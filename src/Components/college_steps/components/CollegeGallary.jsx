    ...
    <div style={{ gap: '20px', display: 'flex', margin: '2.5rem 0px', flexWrap: 'wrap', justifyContent: 'space-between', width: '100%' }}>
      <div className='flex flex-col justify-center items-center'>
        ...
        <div style={{ display: collegeBasicDetails?.college_logo || collegeLogoUrl.length > 0 ? 'block' : 'none', textAlign: 'center' }}>
          <img
            src={collegeLogoUrl.length > 0 ? collegeLogoUrl : constants.newImageAbsolutePath + collegeBasicDetails?.college_logo}
            width={150}
            height={150}
          />
        </div>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        >
          <img
            src={
              collegeThumbnailUrl.length > 0 ? collegeThumbnailUrl : constants.newImageAbsolutePath + collegeBasicDetails?.college_thumbnail
            }
            width={150}
            height={150}
          />
          ...
          <img
            src={
              collegeBrochureUrl.length > 0
                ? collegeBrochureUrl
                : constants.newImageAbsolutePath + collegeBasicDetails?.college_download_brochure_path
            }
            width={150}
            height={150}
          />
