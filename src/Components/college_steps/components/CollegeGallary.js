        ...
        <>
          ...
          >
            <div className='flex flex-col justify-center items-center'>
              ...
              />
              <div
                style={{ display: collegeBasicDetails?.college_logo || collegeLogoUrl.length > 0 ? 'block' : 'none', textAlign: 'center' }}
              >
                <img
                  src={collegeLogoUrl.length > 0 ? collegeLogoUrl : constants.imageAbsolutePath + collegeBasicDetails?.college_logo}
                  width={150}
                  height={150}
                />
              </div>
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <div
                style={{
                  display: collegeBasicDetails?.college_thumbnail || collegeThumbnailUrl.length > 0 ? 'block' : 'none',
                  textAlign: 'center'
                }}
              >
                <img
                  src={
                    collegeThumbnailUrl.length > 0
                      ? collegeThumbnailUrl
                      : constants.imageAbsolutePath + collegeBasicDetails?.college_thumbnail
                  }
                  width={150}
                  height={150}
                />
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <div
                style={{
                  display: collegeBasicDetails?.college_download_brochure_path || collegeBrochureUrl.length > 0 ? 'block' : 'none',
                  textAlign: 'center'
                }}
              >
                <img
                  src={
                    collegeBrochureUrl.length > 0
                      ? collegeBrochureUrl
                      : constants.imageAbsolutePath + collegeBasicDetails?.college_download_brochure_path
                  }
                  width={150}
                  height={150}
                />
