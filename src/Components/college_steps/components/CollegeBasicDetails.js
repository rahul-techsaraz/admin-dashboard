...
const CollegeBasicDetails = ({ collegeId, admin }) => {
    ...
    }, [college_name, category_name.length, location, affiliate_by, ratings, state, city, college_type, college_logo, college_thumbnail, collegeLogo, collegeThumbnail, fee_starting, avg_first_year_fee])
