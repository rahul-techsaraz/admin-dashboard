...
export default function SignIn() {
	...
	const handleRegister = async () => {
		if (
			...
			const json = await httpCall(
				constants.apiEndPoint.ADMIN_REGISTER,
	...
	useEffect(() => {
		if (localStorage.getItem('token')) {
			...
			httpCall(
				constants.apiEndPoint.AUTHENTICATE_USER,
				headers,
										...
										<div className="col-md-6">
											<div className="d-flex">
												...
												{/* <span className="input-group-addon">
													<i className="zmdi zmdi-lock py-2" />
												</span> */}
											</div>
										</div>
										<div className="col-md-6">
									...
									{/* <div className="input-group">
										<div className="flex items-center  gap-2">
											...
											<input
												type="radio"
												name="status"
												class="mx-2 w-[20px] h-[20px] text-[20px]"
												style={{
													width: '16px',
													height: '16px',
													fontSize: '20px',
