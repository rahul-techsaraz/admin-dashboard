          ...
          <div className='col-lg-8 col-md-12'>
            ...
            <div className='card'>
              <div className='header'>
                <h2>
                  <strong>General</strong> Amenities<small>Description Text Here...</small>
                </h2>
            ...
            <div className='card'>
              <div className='header'>
                <h2>
                  <strong>Location</strong> <small>Description text here...</small>{' '}
                </h2>
              </div>
          ...
          <div className='col-lg-4 col-md-12'>
            <div className='card'>
              <div className='body text-center'>
                <a href='#'>
                  <img src={Avt1} className='rounded-circle' alt='profile-image' />
                </a>
