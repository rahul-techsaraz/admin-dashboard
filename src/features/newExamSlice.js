...
const examFormSlice = createSlice({
  ...
  reducers: {
    ...
    setExamDataFromApi: (state, action) => {
      ...
      console.log(data.exam_fee_structure)
      ...
      state.examDescriptions = {
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_OVERVIEW]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_OVERVIEW, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_IMPORTANT_NOTES]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_IMPORTANT_NOTES, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_IMPORTANT_DATES]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_IMPORTANT_DATES, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_ADMIT_CARD]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_ADMIT_CARD, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_PATTERN]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_PATTERN, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_CONDUCTING_BODY]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_CONDUCTING_BODY, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_COUNSELLING]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_COUNSELLING, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP1]: get(
          EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP1,
          '<p>-</p>'
        ),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP2]: get(
          EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP2,
          '<p>-</p>'
        ),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP3]: get(
          EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_APPLICATION_FORM_STEP3,
          '<p>-</p>'
        ),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_INTIMATION_SLIP]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_INTIMATION_SLIP, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_SESSION]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_SESSION, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_CENTER]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_CENTER, '<p>-</p>'),
        [EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_SYLLABUS]: get(EXAM_FIELDS.EXAM_DESCRIPTION.EXAM_SYLLABUS, '<p>-</p>')
      }
