export const constants = {
	apiEndPoint: {
		USER_LOGIN:
			'https://techsaraz.in//admission-cart/api/login/adminlogin/login.php',
		GET_ALL_USERLIST:
			'https://techsaraz.in//admission-cart/api/login/adminlogin/getAllUsers.php',
		AUTHENTICATE_USER:
			'https://techsaraz.in//admission-cart/api/login/adminlogin/user-info.php',
		CATEGORY_LIST:
			'https://techsaraz.in//admission-cart/api/course_category_list.php',
		ADMIN_REGISTER:
			'https://techsaraz.in//admission-cart/api/login/adminlogin/register.php',
		UPDATE_USER_ROLE:
			'https://techsaraz.in//admission-cart/api/login/adminlogin/approved.php',
		EXAM_LIST: 'https://techsaraz.in//admission-cart/api/exam.php',
		COURSE_DETAILS: 'https://techsaraz.in//admission-cart/api/courses.php',
		COLLEGE_DETAILS: 'https://techsaraz.in//admission-cart/api/colleges.php',
	},
	apiHeaders: {
	...
	apiResponseMessage: {
		ERROR_MESSAGE:
			'Your Request could not be processed at the moment. Please try again!',
	},
	sideBarMenu: [
		{
			heading: 'Dashboard',
	...
	addNewCollegeTab: [{label: 'College Basic Details', value: '1'}],
